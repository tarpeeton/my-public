    ...
    return (
        <section className="flex flex-col mt-6 lg:h-[360px] lg:px-20  lg:justify-between  lg:flex-row  lg:items-center bg-gradient-to-tr from-[#012ae3ed] to-[#379FF2] lg:rounded-[40px] rounded-[12px]">
                ...
                <div className="h-full">
                    <Image src="https://ucarecdn.com/8cc822e6-fb4d-4ee4-8348-b4a9baf42711/-/preview/494x505/" width={1000} height={800} quality={100} alt="Service Image" className="object-cover w-full h-full" />
                </div>
